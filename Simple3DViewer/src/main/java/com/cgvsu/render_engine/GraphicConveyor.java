...
public class GraphicConveyor {
    ...
    public static Matrix4x4 rotateScaleTranslate() throws Exception {
        Matrix3x3 s = scale(0.2F);
        Matrix3x3 r = rotate((float) Math.PI / 2);
        Matrix4x4 t = translate(new Vector3f(0,0,0));
